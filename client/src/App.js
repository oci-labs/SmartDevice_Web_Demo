          ...
          <div id="content">
            <section className="row colset-2-its">
              ...
              <p>
                ...
                + React application! While in development mode, changes will be
                loaded automatically when you edit your React app, without even
                    ...
                    ? serverInfo.controllers.map(controller => {
                        return (
                          <li key={controller.name}>
                            <a
                              href={SERVER_URL + controller.logicalPropertyName}
                            >
                              {controller.name}
                            </a>
                          </li>
