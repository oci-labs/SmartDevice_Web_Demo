export const SET_ALL_FACILITIES = "facility:set:all";
export const SET_ALL_DEPARTMENTS = "department:set:all";
export const SET_ALL_MACHINES = "machine:set:all";
export const SET_ALL_ALERTS = "alert:set:all";
export const SET_CURRENT_FACILITY = "facility:set:current";
